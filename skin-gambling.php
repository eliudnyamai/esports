				...
				<div class="m-10">
					...
					<div class="owl-carousel owl-theme" data-items="2" data-auto-play="true">
						...
						<div class="item"><img src="img/bg-04.jpg" alt="Mirror Edge"></div>
							...
							<h1>Présentation du skin Gambling </h1>
							<div>
								<h2>Skin Gambling</h2>
								<p>
                                    Les sports électroniques ont permis le développement de plusieurs concepts autour des paris en ligne. Si l’argent réel est le moyen de paris le plus connu, une nouvelle mise à jour est également autorisée dans la communauté eSport. Il s’agit des monnaies virtuelles que vous pouvez utiliser à travers le skin gambling.
                                </p>
							</div>
                            ...
                            <div>
								<h3>Quels sont les meilleurs sites de skin gambling ?</h3>
								<p>
                            ...
                            <div>
								<h3>Comment obtenir les skins ?</h3>
								<p>
                                Plusieurs alternatives existent pour avoir des skins.
                                </p>
							</div>

                            <div>
								<h3>Lors d’une partie de Counter-Strike : Global Offensive</h3>
								<p>
                            ...
                            <div>
								<h3>Lors des tournois majeurs</h3>
								<p>
                            ...
                            <div>
								<h3>Comment parier avec des skins CS : GO ?</h3>
								<p>
