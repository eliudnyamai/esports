<?php
echo ' <div class="m-03 bg-dark-blue sidebar">
<div class="module-content">
    ...
    <div class="vertical-menu bg-dark-blue module">
        <ul>
            ...
            <li><a rel="nofollow" href="jeux/dota2.php">Dota2</a></li>
            <li><a rel="nofollow" href="jeux/sc2.php">Fifa</a></li>
            <li><a rel="nofollow" href="jeux/overwatch.php">Overwatch</a></li>
            <li><a rel="nofollow" href="jeux/csgo.php">CSGO</a></li>
            <li><a rel="nofollow" href="jeux/fifa.php">Fifa</a></li>
        </ul>
    </div>	
    <div class="tab-dark-blue module">
        <ul class="horizontal tab-nav click-tab">
            <li class="m-06"><h4>Popular</h4></li>
            <li class="m-06"><h4>Recent</h4></li>
        </ul>
        <div class="tab-content ">
            <div class="tab-news">
                ...
                <ul class="tab-news-content">
                    <li class="tab-news-img"><img src="img/mrxbet-bet.jpg" alt=""></li>
