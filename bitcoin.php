					...
					<div class="owl-carousel owl-theme" data-items="2" data-auto-play="true">
						...
						<div class="item"><img src="img/bg-04.jpg" alt="Mirror Edge"></div>
							...
							<div>
                                ...
                                <p>De façon générale, les plateformes qui autorisent les paris en ligne avec du bitcoin dispose d’un guide pour orienter leurs utilisateurs. Il est question d’un document permettant de comprendre l’utilisation du bitcoin lors des opérations de pari en ligne. Il faut toutefois noter que ces différentes opérations s’effectuent à l’aide d’adresses cryptées.</p>
                            </div>
							...
							<div>
                             ...
                             <p>
                             En cliquant sur le service de cryptomonnaie (bitcoin dans ce cas), l’utilisateur est dirigé vers un formulaire classique. Il lui faudra enfin renseigner son adresse bitcoin, ainsi que ses identifiants. Après ces étapes, la transaction est enclenchée et ne nécessite que quelques instants.
                             </p>
                            </div>
							...
							<div>
								...
								<p>
                                 ...
                                 <p>En ce qui concerne les frais, ils peuvent être assez élevés. C’est en effet grâce à ces derniers que le service de change se rémunère principalement et fait fonctionner la plateforme de paris.</p>
                            </div>
						</div>
					</div>
					<div class="share">
